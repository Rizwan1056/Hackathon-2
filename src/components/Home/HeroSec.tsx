...
const HeroSec = () => {
    return (
        <div className='hero h-full lg:h-[718px] text-black flex justify-end items-center'>
            <div className=' bg-white max-w-[643px] lg:h-[443px] xl:mr-[58px]  flex mt-10  justify-center '>
                <div className='w-full xl:w-[561px] flex flex-col items-center p-4 xl:p-0 xl:items-start justify-center mt-4'>
